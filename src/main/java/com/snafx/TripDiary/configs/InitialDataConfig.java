...
public class InitialDataConfig {
    ...
    public void init() {
        ...
        Travel travel = new Travel(user,"Norway", Activity.HIKING, description, description, description,
        ...
        Travel travel2 = new Travel(user2, "Germany", Activity.FOOTBALL, description, description, null,
        ...
        Travel travel3 = new Travel(user3, "Italy", Activity.SNOWBOARDING, description, null, description,
